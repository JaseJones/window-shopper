...
class MainVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        calcBtn.backgroundColor = #colorLiteral(red: 0.0106408987, green: 0.1565708739, blue: 0.8086730647, alpha: 1)
        calcBtn.setTitle("Calculate It", for: .normal)
        calcBtn.setTitleColor(#colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), for: .normal)
        calcBtn.addTarget(self, action:
            #selector(MainVC.calculate), for: .touchUpInside)
